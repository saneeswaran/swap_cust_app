...
class HistoryRedeemDetailsPage extends StatefulWidget {
  const HistoryRedeemDetailsPage({super.key});

  @override
  State<HistoryRedeemDetailsPage> createState() =>
      _HistoryRedeemDetailsPageState();
}

class _HistoryRedeemDetailsPageState extends State<HistoryRedeemDetailsPage> {
  @override
