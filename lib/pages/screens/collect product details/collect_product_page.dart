...
import 'package:geolocator/geolocator.dart' as Geoloceolocator;
...
import '../google map/google_map_page.dart';
import '../product preview/product_preview_page.dart';
...
//google map location
  ...
  void initState() {
    ...
    Geolocator.getServiceStatusStream().listen((serviceStatus) {
      if (serviceStatus == Geoloceolocator.ServiceStatus.enabled) {
        getCurrentLocation();
      }
    });
  }
